...
export class RankingService {
  ...
  getCompetitionRankings(competitionCode: String): Observable<Ranking[]> {
    return this.http
      .get<Ranking[]>(
        this.baseUrl + '/competition?code=' + competitionCode,
        this.httpOptions
      )
      .pipe(catchError((error) => this.configService.handleError(error)));
  }

  setCompetitionRankings(competitionCode: String): Observable<Ranking[]> {
    return this.http
      .get<Ranking[]>(
        this.baseUrl + '/competition/' + competitionCode,
        this.httpOptions
      )
      .pipe(catchError((error) => this.configService.handleError(error)));
  }
  ...
  deleteRanking(identifier: CompetitionMember): Observable<{
    ...
    return this.http
      .delete<{ message: String; deletedElementIdentifier: CompetitionMember }>(
        this.baseUrl +
          '/competition/' +
          identifier.competitionCode +
          '/member/' +
