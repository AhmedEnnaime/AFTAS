    ...
    <div>
      ...
      <input 
        ...
        (input)="onInputChange($event)"
         class="block  mt-2 w-full placeholder-gray-400/70 none:placeholder-gray-500 rounded-lg border border-red-400 bg-white px-5 py-2.5 text-gray-700 focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40 none:border-gray-200 none:bg-gray-900 none:text-gray-300" />
